package com.test.hackerrank.graph;
 ...
 * 
 * Enter the number of vertices and edges in graph 4 5 Enter the edges in graph
 * Format : <source index> <destination index> 1 2 2 3 3 4 4 1 1 3 the given
...
public class Graph {
	...
	/*
	 * Initializes the map to with size equal to number of vertices in a graph Maps
	 * each vertex to a given List Object
	 */
	...
	/*
	 * Main Function reads the number of vertices and edges in a graph. then creates
	 * a Adjacency List for the graph and prints it
	 */
